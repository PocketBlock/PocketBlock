...
;(function (root, factory) {
    ...
    var module$contents$Blockly$PHP_PHP = new $.module$exports$Blockly$Generator.Generator("PHP");
    module$contents$Blockly$PHP_PHP.addReservedWords("__halt_compiler,abstract,and,array,as,break,callable,case,catch,class,clone,const,continue,declare,default,die,do,echo,else,elseif,empty,enddeclare,endfor,endforeach,endif,endswitch,endwhile,eval,exit,extends,final,for,foreach,function,global,goto,if,implements,include,include_once,instanceof,insteadof,interface,isset,list,namespace,new,or,print,private,protected,public,require,require_once,return,static,switch,throw,trait,try,unset,use,var,while,xor,PHP_VERSION,PHP_MAJOR_VERSION,PHP_MINOR_VERSION,PHP_RELEASE_VERSION,PHP_VERSION_ID,PHP_EXTRA_VERSION,PHP_ZTS,PHP_DEBUG,PHP_MAXPATHLEN,PHP_OS,PHP_SAPI,PHP_EOL,PHP_INT_MAX,PHP_INT_SIZE,DEFAULT_INCLUDE_PATH,PEAR_INSTALL_DIR,PEAR_EXTENSION_DIR,PHP_EXTENSION_DIR,PHP_PREFIX,PHP_BINDIR,PHP_BINARY,PHP_MANDIR,PHP_LIBDIR,PHP_DATADIR,PHP_SYSCONFDIR,PHP_LOCALSTATEDIR,PHP_CONFIG_FILE_PATH,PHP_CONFIG_FILE_SCAN_DIR,PHP_SHLIB_SUFFIX,E_ERROR,E_WARNING,E_PARSE,E_NOTICE,E_CORE_ERROR,E_CORE_WARNING,E_COMPILE_ERROR,E_COMPILE_WARNING,E_USER_ERROR,E_USER_WARNING,E_USER_NOTICE,E_DEPRECATED,E_USER_DEPRECATED,E_ALL,E_STRICT,__COMPILER_HALT_OFFSET__,TRUE,FALSE,NULL,__CLASS__,__DIR__,__FILE__,__FUNCTION__,__LINE__,__METHOD__,__NAMESPACE__,__TRAIT__");
    module$contents$Blockly$PHP_PHP.ORDER_ATOMIC = 0;
    module$contents$Blockly$PHP_PHP.ORDER_CLONE = 1;
    module$contents$Blockly$PHP_PHP.ORDER_NEW = 1;
    module$contents$Blockly$PHP_PHP.ORDER_MEMBER = 2.1;
    module$contents$Blockly$PHP_PHP.ORDER_FUNCTION_CALL = 2.2;
    module$contents$Blockly$PHP_PHP.ORDER_POWER = 3;
    module$contents$Blockly$PHP_PHP.ORDER_INCREMENT = 4;
    module$contents$Blockly$PHP_PHP.ORDER_DECREMENT = 4;
    module$contents$Blockly$PHP_PHP.ORDER_BITWISE_NOT = 4;
    module$contents$Blockly$PHP_PHP.ORDER_CAST = 4;
    module$contents$Blockly$PHP_PHP.ORDER_SUPPRESS_ERROR = 4;
    module$contents$Blockly$PHP_PHP.ORDER_INSTANCEOF = 5;
    module$contents$Blockly$PHP_PHP.ORDER_LOGICAL_NOT = 6;
    module$contents$Blockly$PHP_PHP.ORDER_UNARY_PLUS = 7.1;
    module$contents$Blockly$PHP_PHP.ORDER_UNARY_NEGATION = 7.2;
    module$contents$Blockly$PHP_PHP.ORDER_MULTIPLICATION = 8.1;
    module$contents$Blockly$PHP_PHP.ORDER_DIVISION = 8.2;
    module$contents$Blockly$PHP_PHP.ORDER_MODULUS = 8.3;
    module$contents$Blockly$PHP_PHP.ORDER_ADDITION = 9.1;
    module$contents$Blockly$PHP_PHP.ORDER_SUBTRACTION = 9.2;
    module$contents$Blockly$PHP_PHP.ORDER_STRING_CONCAT = 9.3;
    module$contents$Blockly$PHP_PHP.ORDER_BITWISE_SHIFT = 10;
    module$contents$Blockly$PHP_PHP.ORDER_RELATIONAL = 11;
    module$contents$Blockly$PHP_PHP.ORDER_EQUALITY = 12;
    module$contents$Blockly$PHP_PHP.ORDER_REFERENCE = 13;
    module$contents$Blockly$PHP_PHP.ORDER_BITWISE_AND = 13;
    module$contents$Blockly$PHP_PHP.ORDER_BITWISE_XOR = 14;
    module$contents$Blockly$PHP_PHP.ORDER_BITWISE_OR = 15;
    module$contents$Blockly$PHP_PHP.ORDER_LOGICAL_AND = 16;
    module$contents$Blockly$PHP_PHP.ORDER_LOGICAL_OR = 17;
    module$contents$Blockly$PHP_PHP.ORDER_IF_NULL = 18;
    module$contents$Blockly$PHP_PHP.ORDER_CONDITIONAL = 19;
    module$contents$Blockly$PHP_PHP.ORDER_ASSIGNMENT = 20;
    module$contents$Blockly$PHP_PHP.ORDER_LOGICAL_AND_WEAK = 21;
    module$contents$Blockly$PHP_PHP.ORDER_LOGICAL_XOR = 22;
    module$contents$Blockly$PHP_PHP.ORDER_LOGICAL_OR_WEAK = 23;
    module$contents$Blockly$PHP_PHP.ORDER_NONE = 99;
    module$contents$Blockly$PHP_PHP.ORDER_OVERRIDES = [[module$contents$Blockly$PHP_PHP.ORDER_MEMBER, module$contents$Blockly$PHP_PHP.ORDER_FUNCTION_CALL], [module$contents$Blockly$PHP_PHP.ORDER_MEMBER, module$contents$Blockly$PHP_PHP.ORDER_MEMBER], [module$contents$Blockly$PHP_PHP.ORDER_LOGICAL_NOT, module$contents$Blockly$PHP_PHP.ORDER_LOGICAL_NOT], [module$contents$Blockly$PHP_PHP.ORDER_MULTIPLICATION, module$contents$Blockly$PHP_PHP.ORDER_MULTIPLICATION], [module$contents$Blockly$PHP_PHP.ORDER_ADDITION, module$contents$Blockly$PHP_PHP.ORDER_ADDITION],
        [module$contents$Blockly$PHP_PHP.ORDER_LOGICAL_AND, module$contents$Blockly$PHP_PHP.ORDER_LOGICAL_AND], [module$contents$Blockly$PHP_PHP.ORDER_LOGICAL_OR, module$contents$Blockly$PHP_PHP.ORDER_LOGICAL_OR]];
    module$contents$Blockly$PHP_PHP.isInitialized = !1;
    module$contents$Blockly$PHP_PHP.init = function (a) {
    ...
    module$contents$Blockly$PHP_PHP.finish = function (a) {
    ...
    module$contents$Blockly$PHP_PHP.scrubNakedValue = function (a) {
        return a + ";\n"
    };
    module$contents$Blockly$PHP_PHP.quote_ = function (a) {
        a = a.replace(/\\/g, "\\\\").replace(/\n/g, "\\\n").replace(/'/g, "\\'");
        return "'" + a + "'"
    };
    module$contents$Blockly$PHP_PHP.multiline_quote_ = function (a) {
        return a.split(/\n/g).map(this.quote_).join(' . "\\n" .\n')
    };
    module$contents$Blockly$PHP_PHP.scrub_ = function (a, b, c) {
        var d = "";
    ...
    module$contents$Blockly$PHP_PHP.getAdjusted = function (a, b, c, d, e) {
        c = c || 0;
        e = e || this.ORDER_NONE;
        a.workspace.options.oneBasedIndex && c--;
        var f = a.workspace.options.oneBasedIndex ? "1" : "0", g = e;
        ...
        (0, $.module$exports$Blockly$utils$string.isNumber)(a) ? (a = Number(a) + c, d && (a = -a)) : (0 < c ? a = a + " + " + c : 0 > c && (a = a + " - " + -c), d && (a = c ? "-(" + a + ")" : "-" + a), h = Math.floor(h), e = Math.floor(e), h && e >= h &&
        (a = "(" + a + ")"));
        return a
    };
    $.Blockly.PHP = module$contents$Blockly$PHP_PHP;
    var module$exports$Blockly$PHP$variables = {};
    $.Blockly.PHP.variables_get = function (a) {
        return [$.Blockly.PHP.nameDB_.getName(a.getFieldValue("VAR"), $.module$exports$Blockly$Names.NameType.VARIABLE), $.Blockly.PHP.ORDER_ATOMIC]
    };
    $.Blockly.PHP.variables_set = function (a) {
        var b = $.Blockly.PHP.valueToCode(a, "VALUE", $.Blockly.PHP.ORDER_ASSIGNMENT) || "0";
        return $.Blockly.PHP.nameDB_.getName(a.getFieldValue("VAR"), $.module$exports$Blockly$Names.NameType.VARIABLE) + " = " + b + ";\n"
    };
    ...
    var module$exports$Blockly$PHP$texts = {};
    $.Blockly.PHP.text = function (a) {
        return [$.Blockly.PHP.quote_(a.getFieldValue("TEXT")), $.Blockly.PHP.ORDER_ATOMIC]
    };
    $.Blockly.PHP.text_multiline = function (a) {
        a = $.Blockly.PHP.multiline_quote_(a.getFieldValue("TEXT"));
        var b = -1 !== a.indexOf(".") ? $.Blockly.PHP.ORDER_STRING_CONCAT : $.Blockly.PHP.ORDER_ATOMIC;
        return [a, b]
    };
    $.Blockly.PHP.text_join = function (a) {
        if (0 === a.itemCount_) return ["''", $.Blockly.PHP.ORDER_ATOMIC];
        if (1 === a.itemCount_) return [$.Blockly.PHP.valueToCode(a, "ADD0", $.Blockly.PHP.ORDER_NONE) || "''", $.Blockly.PHP.ORDER_NONE];
        if (2 === a.itemCount_) {
            var b = $.Blockly.PHP.valueToCode(a, "ADD0", $.Blockly.PHP.ORDER_STRING_CONCAT) || "''";
            a = $.Blockly.PHP.valueToCode(a, "ADD1", $.Blockly.PHP.ORDER_STRING_CONCAT) || "''";
            return [b + " . " + a, $.Blockly.PHP.ORDER_STRING_CONCAT]
        }
        b = Array(a.itemCount_);
        for (var c = 0; c < a.itemCount_; c++) b[c] =
            $.Blockly.PHP.valueToCode(a, "ADD" + c, $.Blockly.PHP.ORDER_NONE) || "''";
        return ["implode('', array(" + b.join(",") + "))", $.Blockly.PHP.ORDER_FUNCTION_CALL]
    };
    $.Blockly.PHP.text_append = function (a) {
        var b = $.Blockly.PHP.nameDB_.getName(a.getFieldValue("VAR"), $.module$exports$Blockly$Names.NameType.VARIABLE);
        a = $.Blockly.PHP.valueToCode(a, "TEXT", $.Blockly.PHP.ORDER_ASSIGNMENT) || "''";
        return b + " .= " + a + ";\n"
    };
    $.Blockly.PHP.text_length = function (a) {
        var b = $.Blockly.PHP.provideFunction_("length", "\nfunction " + $.Blockly.PHP.FUNCTION_NAME_PLACEHOLDER_ + "($value) {\n  if (is_string($value)) {\n    return strlen($value);\n  }\n  return count($value);\n}\n");
    ...
    $.Blockly.PHP.text_indexOf = function (a) {
        var b = "FIRST" === a.getFieldValue("END") ? "strpos" : "strrpos",
            ...
            d = $.Blockly.PHP.valueToCode(a, "VALUE", $.Blockly.PHP.ORDER_NONE) || "''", e = " -1", f = "";
        a.workspace.options.oneBasedIndex && (e = " 0", f = " + 1");
        return [$.Blockly.PHP.provideFunction_("FIRST" === a.getFieldValue("END") ? "text_indexOf" : "text_lastIndexOf", "\nfunction " + $.Blockly.PHP.FUNCTION_NAME_PLACEHOLDER_ + "($text, $search) {\n  $pos = " + b + "($text, $search);\n  return $pos === false ? " +
            e + " : $pos" + f + ";\n}\n") + "(" + d + ", " + c + ")", $.Blockly.PHP.ORDER_FUNCTION_CALL]
    };
    $.Blockly.PHP.text_charAt = function (a) {
        var b = a.getFieldValue("WHERE") || "FROM_START",
            c = $.Blockly.PHP.valueToCode(a, "VALUE", $.Blockly.PHP.ORDER_NONE) || "''";
        switch (b) {
            case "FIRST":
            ...
            case "FROM_END":
                return a = $.Blockly.PHP.getAdjusted(a, "AT", 1, !0),
                    ["substr(" + c + ", " + a + ", 1)", $.Blockly.PHP.ORDER_FUNCTION_CALL];
            case "RANDOM":
                return [$.Blockly.PHP.provideFunction_("text_random_letter", "\nfunction " + $.Blockly.PHP.FUNCTION_NAME_PLACEHOLDER_ + "($text) {\n  return $text[rand(0, strlen($text) - 1)];\n}\n") + "(" + c + ")", $.Blockly.PHP.ORDER_FUNCTION_CALL]
        }
        throw Error("Unhandled option (text_charAt).");
    };
    $.Blockly.PHP.text_getSubstring = function (a) {
        var b = a.getFieldValue("WHERE1"), c = a.getFieldValue("WHERE2"),
            d = $.Blockly.PHP.valueToCode(a, "STRING", $.Blockly.PHP.ORDER_NONE) || "''";
        if ("FIRST" === b && "LAST" === c) return [d, $.Blockly.PHP.ORDER_NONE];
        var e = $.Blockly.PHP.getAdjusted(a, "AT1");
        a = $.Blockly.PHP.getAdjusted(a, "AT2");
        return [$.Blockly.PHP.provideFunction_("text_get_substring", "\nfunction " + $.Blockly.PHP.FUNCTION_NAME_PLACEHOLDER_ + "($text, $where1, $at1, $where2, $at2) {\n  if ($where1 == 'FROM_END') {\n    $at1 = strlen($text) - 1 - $at1;\n  } else if ($where1 == 'FIRST') {\n    $at1 = 0;\n  } else if ($where1 != 'FROM_START') {\n    throw new Exception('Unhandled option (text_get_substring).');\n  }\n  $length = 0;\n  if ($where2 == 'FROM_START') {\n    $length = $at2 - $at1 + 1;\n  } else if ($where2 == 'FROM_END') {\n    $length = strlen($text) - $at1 - $at2;\n  } else if ($where2 == 'LAST') {\n    $length = strlen($text) - $at1;\n  } else {\n    throw new Exception('Unhandled option (text_get_substring).');\n  }\n  return substr($text, $at1, $length);\n}\n") +
        "(" + d + ", '" + b + "', " + e + ", '" + c + "', " + a + ")", $.Blockly.PHP.ORDER_FUNCTION_CALL]
    };
    $.Blockly.PHP.text_changeCase = function (a) {
        var b = $.Blockly.PHP.valueToCode(a, "TEXT", $.Blockly.PHP.ORDER_NONE) || "''", c;
    ...
    $.Blockly.PHP.text_trim = function (a) {
        var b = {LEFT: "ltrim", RIGHT: "rtrim", BOTH: "trim"}[a.getFieldValue("MODE")];
    ...
    $.Blockly.PHP.text_reverse = function (a) {
        return ["strrev(" + ($.Blockly.PHP.valueToCode(a, "TEXT", $.Blockly.PHP.ORDER_NONE) || "''") + ")", $.Blockly.PHP.ORDER_FUNCTION_CALL]
    };
    var module$exports$Blockly$PHP$procedures = {};
    $.Blockly.PHP.procedures_defreturn = function (a) {
        for (var b = [], c = a.workspace, d = (0, $.module$exports$Blockly$Variables.allUsedVarModels)(c) || [], e = 0, f; f = d[e]; e++) f = f.name, -1 === a.getVars().indexOf(f) && b.push($.Blockly.PHP.nameDB_.getName(f, $.module$exports$Blockly$Names.NameType.VARIABLE));
        c = (0, $.module$exports$Blockly$Variables.allDeveloperVariables)(c);
        for (d = 0; d < c.length; d++) b.push($.Blockly.PHP.nameDB_.getName(c[d], $.module$exports$Blockly$Names.NameType.DEVELOPER_VARIABLE));
        c = b.length ? $.Blockly.PHP.INDENT +
            "global " + b.join(", ") + ";\n" : "";
        b = $.Blockly.PHP.nameDB_.getName(a.getFieldValue("NAME"), $.module$exports$Blockly$Names.NameType.PROCEDURE);
        d = "";
        $.Blockly.PHP.STATEMENT_PREFIX && (d += $.Blockly.PHP.injectId($.Blockly.PHP.STATEMENT_PREFIX, a));
        $.Blockly.PHP.STATEMENT_SUFFIX && (d += $.Blockly.PHP.injectId($.Blockly.PHP.STATEMENT_SUFFIX, a));
        d && (d = $.Blockly.PHP.prefixLines(d, $.Blockly.PHP.INDENT));
        e = "";
        $.Blockly.PHP.INFINITE_LOOP_TRAP && (e = $.Blockly.PHP.prefixLines($.Blockly.PHP.injectId($.Blockly.PHP.INFINITE_LOOP_TRAP,
            a), $.Blockly.PHP.INDENT));
        f = $.Blockly.PHP.statementToCode(a, "STACK");
        var g = $.Blockly.PHP.valueToCode(a, "RETURN", $.Blockly.PHP.ORDER_NONE) || "", h = "";
        f && g && (h = d);
        g && (g = $.Blockly.PHP.INDENT + "return " + g + ";\n");
        for (var k = [], l = a.getVars(), m = 0; m < l.length; m++) k[m] = $.Blockly.PHP.nameDB_.getName(l[m], $.module$exports$Blockly$Names.NameType.VARIABLE);
        c = "function " + b + "(" + k.join(", ") + ") {\n" + c + d + e + f + h + g + "}";
        c = $.Blockly.PHP.scrub_(a, c);
        $.Blockly.PHP.definitions_["%" + b] = c;
        return null
    };
    $.Blockly.PHP.procedures_defnoreturn = $.Blockly.PHP.procedures_defreturn;
    $.Blockly.PHP.procedures_callreturn = function (a) {
        for (var b = $.Blockly.PHP.nameDB_.getName(a.getFieldValue("NAME"), $.module$exports$Blockly$Names.NameType.PROCEDURE), c = [], d = a.getVars(), e = 0; e < d.length; e++) c[e] = $.Blockly.PHP.valueToCode(a, "ARG" + e, $.Blockly.PHP.ORDER_NONE) || "null";
    ...
    var module$exports$Blockly$PHP$math = {};
    ...
    $.Blockly.PHP.math_number_property = function (a) {
        var b = {
            EVEN: ["", " % 2 == 0", $.Blockly.PHP.ORDER_MODULUS, $.Blockly.PHP.ORDER_EQUALITY],
            ODD: ["", " % 2 == 1", $.Blockly.PHP.ORDER_MODULUS, $.Blockly.PHP.ORDER_EQUALITY],
            WHOLE: ["is_int(", ")", $.Blockly.PHP.ORDER_NONE, $.Blockly.PHP.ORDER_FUNCTION_CALL],
            POSITIVE: ["", " > 0", $.Blockly.PHP.ORDER_RELATIONAL, $.Blockly.PHP.ORDER_RELATIONAL],
            NEGATIVE: ["", " < 0", $.Blockly.PHP.ORDER_RELATIONAL, $.Blockly.PHP.ORDER_RELATIONAL],
            DIVISIBLE_BY: [null, null, $.Blockly.PHP.ORDER_MODULUS,
                $.Blockly.PHP.ORDER_EQUALITY],
            PRIME: [null, null, $.Blockly.PHP.ORDER_NONE, $.Blockly.PHP.ORDER_FUNCTION_CALL]
        }, c = a.getFieldValue("PROPERTY");
        b = $.$jscomp.makeIterator(b[c]);
        var d = b.next().value, e = b.next().value, f = b.next().value;
        b = b.next().value;
        f = $.Blockly.PHP.valueToCode(a, "NUMBER_TO_CHECK", f) || "0";
        if ("PRIME" === c) a = $.Blockly.PHP.provideFunction_("math_isPrime", "\nfunction " + $.Blockly.PHP.FUNCTION_NAME_PLACEHOLDER_ + "($n) {\n  // https://en.wikipedia.org/wiki/Primality_test#Naive_methods\n  if ($n == 2 || $n == 3) {\n    return true;\n  }\n  // False if n is NaN, negative, is 1, or not whole.\n  // And false if n is divisible by 2 or 3.\n  if (!is_numeric($n) || $n <= 1 || $n % 1 != 0 || $n % 2 == 0 || $n % 3 == 0) {\n    return false;\n  }\n  // Check all the numbers of form 6k +/- 1, up to sqrt(n).\n  for ($x = 6; $x <= sqrt($n) + 1; $x += 6) {\n    if ($n % ($x - 1) == 0 || $n % ($x + 1) == 0) {\n      return false;\n    }\n  }\n  return true;\n}\n") +
            "(" + f + ")"; else if ("DIVISIBLE_BY" === c) {
            a = $.Blockly.PHP.valueToCode(a, "DIVISOR", $.Blockly.PHP.ORDER_MODULUS) || "0";
            if ("0" === a) return ["false", $.Blockly.PHP.ORDER_ATOMIC];
            a = f + " % " + a + " == 0"
        } else a = d + f + e;
        return [a, b]
    };
    ...
    $.Blockly.PHP.math_constrain = function (a) {
        var b = $.Blockly.PHP.valueToCode(a, "VALUE", $.Blockly.PHP.ORDER_NONE) || "0",
            c = $.Blockly.PHP.valueToCode(a, "LOW", $.Blockly.PHP.ORDER_NONE) || "0";
        a = $.Blockly.PHP.valueToCode(a, "HIGH", $.Blockly.PHP.ORDER_NONE) || "Infinity";
        return ["min(max(" + b + ", " + c + "), " + a + ")", $.Blockly.PHP.ORDER_FUNCTION_CALL]
    };
    $.Blockly.PHP.math_random_int = function (a) {
        var b = $.Blockly.PHP.valueToCode(a, "FROM", $.Blockly.PHP.ORDER_NONE) || "0";
        a = $.Blockly.PHP.valueToCode(a, "TO", $.Blockly.PHP.ORDER_NONE) || "0";
        return [$.Blockly.PHP.provideFunction_("math_random_int", "\nfunction " + $.Blockly.PHP.FUNCTION_NAME_PLACEHOLDER_ + "($a, $b) {\n  if ($a > $b) {\n    return rand($b, $a);\n  }\n  return rand($a, $b);\n}\n") + "(" + b + ", " + a + ")", $.Blockly.PHP.ORDER_FUNCTION_CALL]
    };
    ...
    $.Blockly.PHP.math_atan2 = function (a) {
        var b = $.Blockly.PHP.valueToCode(a, "X", $.Blockly.PHP.ORDER_NONE) || "0";
        return ["atan2(" + ($.Blockly.PHP.valueToCode(a, "Y", $.Blockly.PHP.ORDER_NONE) || "0") + ", " + b + ") / pi() * 180", $.Blockly.PHP.ORDER_DIVISION]
    };
    var module$exports$Blockly$PHP$loops = {};
    $.Blockly.PHP.controls_repeat_ext = function (a) {
        ...
        a = "";
        var d = $.Blockly.PHP.nameDB_.getDistinctName("count", $.module$exports$Blockly$Names.NameType.VARIABLE), e = b;
        b.match(/^\w+$/) || (0, $.module$exports$Blockly$utils$string.isNumber)(b) || (e = $.Blockly.PHP.nameDB_.getDistinctName("repeat_end", $.module$exports$Blockly$Names.NameType.VARIABLE),
            a += e + " = " + b + ";\n");
    ...
    $.Blockly.PHP.controls_for = function (a) {
        ...
        if ((0, $.module$exports$Blockly$utils$string.isNumber)(c) && (0, $.module$exports$Blockly$utils$string.isNumber)(d) &&
            (0, $.module$exports$Blockly$utils$string.isNumber)(e)) {
    ...
    var module$exports$Blockly$PHP$lists = {};
    ...
    $.Blockly.PHP.lists_create_with = function (a) {
        for (var b = Array(a.itemCount_), c = 0; c < a.itemCount_; c++) b[c] = $.Blockly.PHP.valueToCode(a, "ADD" + c, $.Blockly.PHP.ORDER_NONE) || "null";
        b = "array(" + b.join(", ") + ")";
        return [b, $.Blockly.PHP.ORDER_FUNCTION_CALL]
    };
    $.Blockly.PHP.lists_repeat = function (a) {
        var b = $.Blockly.PHP.provideFunction_("lists_repeat", "\nfunction " + $.Blockly.PHP.FUNCTION_NAME_PLACEHOLDER_ + "($value, $count) {\n  $array = array();\n  for ($index = 0; $index < $count; $index++) {\n    $array[] = $value;\n  }\n  return $array;\n}\n"),
            c = $.Blockly.PHP.valueToCode(a, "ITEM", $.Blockly.PHP.ORDER_NONE) || "null";
        a = $.Blockly.PHP.valueToCode(a, "NUM", $.Blockly.PHP.ORDER_NONE) || "0";
    ...
    $.Blockly.PHP.lists_getIndex = function (a) {
        ...
        switch (a.getFieldValue("WHERE") || "FROM_START") {
            case "FIRST":
                if ("GET" === b) return [($.Blockly.PHP.valueToCode(a, "VALUE", $.Blockly.PHP.ORDER_MEMBER) || "array()") + "[0]", $.Blockly.PHP.ORDER_MEMBER];
                if ("GET_REMOVE" === b) return ["array_shift(" + ($.Blockly.PHP.valueToCode(a, "VALUE", $.Blockly.PHP.ORDER_NONE) || "array()") + ")", $.Blockly.PHP.ORDER_FUNCTION_CALL];
                if ("REMOVE" === b) return "array_shift(" + ($.Blockly.PHP.valueToCode(a, "VALUE", $.Blockly.PHP.ORDER_NONE) ||
                    "array()") + ");\n";
                break;
            case "LAST":
                if ("GET" === b) return ["end(" + ($.Blockly.PHP.valueToCode(a, "VALUE", $.Blockly.PHP.ORDER_NONE) || "array()") + ")", $.Blockly.PHP.ORDER_FUNCTION_CALL];
                if ("GET_REMOVE" === b) return ["array_pop(" + ($.Blockly.PHP.valueToCode(a, "VALUE", $.Blockly.PHP.ORDER_NONE) || "array()") + ")", $.Blockly.PHP.ORDER_FUNCTION_CALL];
                if ("REMOVE" === b) return "array_pop(" + ($.Blockly.PHP.valueToCode(a, "VALUE", $.Blockly.PHP.ORDER_NONE) || "array()") + ");\n";
                break;
            case "FROM_START":
                var c = $.Blockly.PHP.getAdjusted(a,
                    "AT");
                if ("GET" === b) return [($.Blockly.PHP.valueToCode(a, "VALUE", $.Blockly.PHP.ORDER_MEMBER) || "array()") + "[" + c + "]", $.Blockly.PHP.ORDER_MEMBER];
                if ("GET_REMOVE" === b) return ["array_splice(" + ($.Blockly.PHP.valueToCode(a, "VALUE", $.Blockly.PHP.ORDER_NONE) || "array()") + ", " + c + ", 1)[0]", $.Blockly.PHP.ORDER_FUNCTION_CALL];
                if ("REMOVE" === b) return "array_splice(" + ($.Blockly.PHP.valueToCode(a, "VALUE", $.Blockly.PHP.ORDER_NONE) || "array()") + ", " + c + ", 1);\n";
                break;
            case "FROM_END":
                if ("GET" === b) return b = $.Blockly.PHP.valueToCode(a,
                    "VALUE", $.Blockly.PHP.ORDER_NONE) || "array()", a = $.Blockly.PHP.getAdjusted(a, "AT", 1, !0), ["array_slice(" + b + ", " + a + ", 1)[0]", $.Blockly.PHP.ORDER_FUNCTION_CALL];
                if ("GET_REMOVE" === b || "REMOVE" === b) {
                    c = $.Blockly.PHP.valueToCode(a, "VALUE", $.Blockly.PHP.ORDER_NONE) || "array()";
                    a = $.Blockly.PHP.getAdjusted(a, "AT", 1, !1, $.Blockly.PHP.ORDER_SUBTRACTION);
                    a = "array_splice(" + c + ", count(" + c + ") - " + a + ", 1)[0]";
                    if ("GET_REMOVE" === b) return [a, $.Blockly.PHP.ORDER_FUNCTION_CALL];
                    if ("REMOVE" === b) return a + ";\n"
                }
                break;
            case "RANDOM":
                a =
                    $.Blockly.PHP.valueToCode(a, "VALUE", $.Blockly.PHP.ORDER_NONE) || "array()";
                if ("GET" === b) return [$.Blockly.PHP.provideFunction_("lists_get_random_item", "\nfunction " + $.Blockly.PHP.FUNCTION_NAME_PLACEHOLDER_ + "($list) {\n  return $list[rand(0,count($list)-1)];\n}\n") + "(" + a + ")", $.Blockly.PHP.ORDER_FUNCTION_CALL];
                if ("GET_REMOVE" === b) return [$.Blockly.PHP.provideFunction_("lists_get_remove_random_item", "\nfunction " + $.Blockly.PHP.FUNCTION_NAME_PLACEHOLDER_ + "(&$list) {\n  $x = rand(0,count($list)-1);\n  unset($list[$x]);\n  return array_values($list);\n}\n") +
                "(" + a + ")", $.Blockly.PHP.ORDER_FUNCTION_CALL];
                if ("REMOVE" === b) return $.Blockly.PHP.provideFunction_("lists_remove_random_item", "\nfunction " + $.Blockly.PHP.FUNCTION_NAME_PLACEHOLDER_ + "(&$list) {\n  unset($list[rand(0,count($list)-1)]);\n}\n") + "(" + a + ");\n"
        }
    ...
    $.Blockly.PHP.lists_setIndex = function (a) {
        ...
        switch (c) {
            case "FIRST":
                if ("SET" === b) return ($.Blockly.PHP.valueToCode(a, "LIST", $.Blockly.PHP.ORDER_MEMBER) || "array()") + "[0] = " + d + ";\n";
                if ("INSERT" === b) return "array_unshift(" + ($.Blockly.PHP.valueToCode(a, "LIST", $.Blockly.PHP.ORDER_NONE) || "array()") + ", " + d + ");\n";
                break;
            case "LAST":
                a = $.Blockly.PHP.valueToCode(a,
                    "LIST", $.Blockly.PHP.ORDER_NONE) || "array()";
                if ("SET" === b) return $.Blockly.PHP.provideFunction_("lists_set_last_item", "\nfunction " + $.Blockly.PHP.FUNCTION_NAME_PLACEHOLDER_ + "(&$list, $value) {\n  $list[count($list) - 1] = $value;\n}\n") + "(" + a + ", " + d + ");\n";
                if ("INSERT" === b) return "array_push(" + a + ", " + d + ");\n";
                break;
            case "FROM_START":
                c = $.Blockly.PHP.getAdjusted(a, "AT");
                if ("SET" === b) return ($.Blockly.PHP.valueToCode(a, "LIST", $.Blockly.PHP.ORDER_MEMBER) || "array()") + "[" + c + "] = " + d + ";\n";
                if ("INSERT" === b) return "array_splice(" +
                    ($.Blockly.PHP.valueToCode(a, "LIST", $.Blockly.PHP.ORDER_NONE) || "array()") + ", " + c + ", 0, " + d + ");\n";
                break;
            case "FROM_END":
                c = $.Blockly.PHP.valueToCode(a, "LIST", $.Blockly.PHP.ORDER_NONE) || "array()";
                a = $.Blockly.PHP.getAdjusted(a, "AT", 1);
                if ("SET" === b) return $.Blockly.PHP.provideFunction_("lists_set_from_end", "\nfunction " + $.Blockly.PHP.FUNCTION_NAME_PLACEHOLDER_ + "(&$list, $at, $value) {\n  $list[count($list) - $at] = $value;\n}\n") + "(" + c + ", " + a + ", " + d + ");\n";
                if ("INSERT" === b) return $.Blockly.PHP.provideFunction_("lists_insert_from_end",
                    "\nfunction " + $.Blockly.PHP.FUNCTION_NAME_PLACEHOLDER_ + "(&$list, $at, $value) {\n  return array_splice($list, count($list) - $at, 0, $value);\n}\n") + "(" + c + ", " + a + ", " + d + ");\n";
                break;
            case "RANDOM":
                a = $.Blockly.PHP.valueToCode(a, "LIST", $.Blockly.PHP.ORDER_REFERENCE) || "array()";
                if (a.match(/^\$\w+$/)) c = ""; else {
                    c = $.Blockly.PHP.nameDB_.getDistinctName("tmp_list", $.module$exports$Blockly$Names.NameType.VARIABLE);
                    var e = c + " = &" + a + ";\n";
                    a = c;
                    c = e
                }
                e = $.Blockly.PHP.nameDB_.getDistinctName("tmp_x", $.module$exports$Blockly$Names.NameType.VARIABLE);
    ...
    $.Blockly.PHP.lists_getSublist = function (a) {
        var b = $.Blockly.PHP.valueToCode(a, "LIST", $.Blockly.PHP.ORDER_NONE) || "array()",
            c = a.getFieldValue("WHERE1"), d = a.getFieldValue("WHERE2");
        if ("FIRST" !== c || "LAST" !== d) if (b.match(/^\$\w+$/) || "FROM_END" !== c && "FROM_START" === d) {
            switch (c) {
                case "FROM_START":
                    c = $.Blockly.PHP.getAdjusted(a, "AT1");
                    break;
                case "FROM_END":
                    c = $.Blockly.PHP.getAdjusted(a, "AT1", 1, !1, $.Blockly.PHP.ORDER_SUBTRACTION);
                    c = "count(" + b + ") - " + c;
                    break;
                case "FIRST":
                    c = "0";
            ...
            switch (d) {
                case "FROM_START":
                    d = $.Blockly.PHP.getAdjusted(a, "AT2", 0, !1, $.Blockly.PHP.ORDER_SUBTRACTION);
                    d += " - ";
                    d = (0, $.module$exports$Blockly$utils$string.isNumber)(String(c)) || String(c).match(/^\(.+\)$/) ? d + c : d + ("(" + c + ")");
                    d += " + 1";
                    break;
                case "FROM_END":
                    d = $.Blockly.PHP.getAdjusted(a, "AT2", 0, !1, $.Blockly.PHP.ORDER_SUBTRACTION);
    ...
    $.Blockly.PHP.lists_reverse = function (a) {
        return ["array_reverse(" + ($.Blockly.PHP.valueToCode(a, "LIST", $.Blockly.PHP.ORDER_NONE) || "[]") + ")", $.Blockly.PHP.ORDER_FUNCTION_CALL]
    };
    ...
    $.Blockly.PHP.colour_random = function (a) {
        return [$.Blockly.PHP.provideFunction_("colour_random", "\nfunction " + $.Blockly.PHP.FUNCTION_NAME_PLACEHOLDER_ + "() {\n  return '#' . str_pad(dechex(mt_rand(0, 0xFFFFFF)), 6, '0', STR_PAD_LEFT);\n}\n") + "()", $.Blockly.PHP.ORDER_FUNCTION_CALL]
    };
    $.Blockly.PHP.colour_rgb = function (a) {
        var b = $.Blockly.PHP.valueToCode(a, "RED", $.Blockly.PHP.ORDER_NONE) || 0,
            c = $.Blockly.PHP.valueToCode(a, "GREEN", $.Blockly.PHP.ORDER_NONE) || 0;
        a = $.Blockly.PHP.valueToCode(a, "BLUE", $.Blockly.PHP.ORDER_NONE) || 0;
        return [$.Blockly.PHP.provideFunction_("colour_rgb", "\nfunction " + $.Blockly.PHP.FUNCTION_NAME_PLACEHOLDER_ + "($r, $g, $b) {\n  $r = round(max(min($r, 100), 0) * 2.55);\n  $g = round(max(min($g, 100), 0) * 2.55);\n  $b = round(max(min($b, 100), 0) * 2.55);\n  $hex = '#';\n  $hex .= str_pad(dechex($r), 2, '0', STR_PAD_LEFT);\n  $hex .= str_pad(dechex($g), 2, '0', STR_PAD_LEFT);\n  $hex .= str_pad(dechex($b), 2, '0', STR_PAD_LEFT);\n  return $hex;\n}\n") +
        "(" + b + ", " + c + ", " + a + ")", $.Blockly.PHP.ORDER_FUNCTION_CALL]
    };
    $.Blockly.PHP.colour_blend = function (a) {
        var b = $.Blockly.PHP.valueToCode(a, "COLOUR1", $.Blockly.PHP.ORDER_NONE) || "'#000000'",
            c = $.Blockly.PHP.valueToCode(a, "COLOUR2", $.Blockly.PHP.ORDER_NONE) || "'#000000'";
        a = $.Blockly.PHP.valueToCode(a, "RATIO", $.Blockly.PHP.ORDER_NONE) || .5;
        return [$.Blockly.PHP.provideFunction_("colour_blend", "\nfunction " + $.Blockly.PHP.FUNCTION_NAME_PLACEHOLDER_ + "($c1, $c2, $ratio) {\n  $ratio = max(min($ratio, 1), 0);\n  $r1 = hexdec(substr($c1, 1, 2));\n  $g1 = hexdec(substr($c1, 3, 2));\n  $b1 = hexdec(substr($c1, 5, 2));\n  $r2 = hexdec(substr($c2, 1, 2));\n  $g2 = hexdec(substr($c2, 3, 2));\n  $b2 = hexdec(substr($c2, 5, 2));\n  $r = round($r1 * (1 - $ratio) + $r2 * $ratio);\n  $g = round($g1 * (1 - $ratio) + $g2 * $ratio);\n  $b = round($b1 * (1 - $ratio) + $b2 * $ratio);\n  $hex = '#';\n  $hex .= str_pad(dechex($r), 2, '0', STR_PAD_LEFT);\n  $hex .= str_pad(dechex($g), 2, '0', STR_PAD_LEFT);\n  $hex .= str_pad(dechex($b), 2, '0', STR_PAD_LEFT);\n  return $hex;\n}\n") + "(" +
        b + ", " + c + ", " + a + ")", $.Blockly.PHP.ORDER_FUNCTION_CALL]
    };
    var module$exports$Blockly$PHP$all = {};
